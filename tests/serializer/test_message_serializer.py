...
def test_encode_with_schema_id(client, message_serializer):
    basic = schema.load_schema(data_gen.BASIC_SCHEMA)
    ...
    adv = schema.load_schema(data_gen.ADVANCED_SCHEMA)
...
def test_encode_logical_types(client, message_serializer):
    logical_types_schema = schema.load_schema(data_gen.LOGICAL_TYPES_SCHEMA)
