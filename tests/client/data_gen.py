...
AVRO_SCHEMAS_DIR = os.path.join(os.path.dirname(
...
BASIC_SCHEMA = load_schema_file(
    os.path.join(AVRO_SCHEMAS_DIR, 'basic_schema.avsc'))
...
ADVANCED_SCHEMA = load_schema_file(
    os.path.join(AVRO_SCHEMAS_DIR, 'adv_schema.avsc'))
